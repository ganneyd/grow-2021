...
class _$ProfileStateTearOff {
  ...
  _ProfileState call({ProfileStatus status = ProfileStatus.loading}) {
...
class _$_ProfileState implements _ProfileState {
  _$_ProfileState({this.status = ProfileStatus.loading});

  @JsonKey(defaultValue: ProfileStatus.loading)
  @override
...
abstract class _ProfileState implements ProfileState {
  factory _ProfileState({ProfileStatus status}) = _$_ProfileState;
