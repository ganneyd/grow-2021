...
const _validatedFormzStatuses = <FormStatus>{
  FormStatus.valid,
...
/// [FormStatus] and [FormzInputStatus] instances.
class Formz {
  /// Returns a [FormStatus] given a list of [FormzInput].
  static FormStatus validate(List<FormzInput> inputs) {
    assert(inputs != null);
...
/// ```
mixin FormzMixin {
  /// [FormStatus] getter which computes the status based on the
  /// validity of the [inputs].
  FormStatus get status => Formz.validate(inputs);
