...
import 'package:grow_run_v1/features/grow/domain/usecases/parent/get_parents.dart';
...
void main() {
  ...
  final GetListOfParents usecase = GetListOfParents(repository);
    ...
    test(
      ...
      () async {
        ...
        final Either<Failure, List<ParentEntity>> result =
            await usecase.call(const Params('requestedBy'));
